	...
	<!-- --------------------------------------------------------------------------------------- -->
		<div id="interface">
			...
			<div id="Conteudo">
				<div align="center">
					<br/>
					<h2 align="center"> <font color="336699"> Produto </font></h2> 
					<br/>
					<hr width="45%">
					<form action="form_produto.php" method="post" name="buscar" align="center">
				...
				<?php
					...
					if(isset($_POST["buscar"])){
						...
						include("form_produto_listar.php");
					}
					...
					if(isset($_POST["cadastrar"])){
						$descricao = $_POST['descricao'];
						include('../controller/produto_cadastrar.php');
					}
